  ...
  return (
    <div  name='about' className='w-full h-screen bg-gradient-to-r from-[#050d1c] to-[#0d8bb9] text-gray-300'>
      ...
      <div className='text-center max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              <h1 className='text-4xl font-bold inline border-b-4 border-[#dbb434]'>WHO WE ARE</h1>
              <p className='font-bold p-8'>At Create IT Recruitment, we have developed a simplified approach to recruitment which, we know you’ll love!</p>
