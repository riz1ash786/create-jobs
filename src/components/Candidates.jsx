      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='text-center max-w-[1000px] w-full grid gap-8'>
          ...
          <div>
            ...
            <p className='pt-8 text-center text-[#dbb434]'>LISTEN</p> <p className=' pt-2 text-center'>We aim to understand you: your motivations, aspirations, needs, desires, preferences, and aversions. Meaningful conversations drive us forward.</p>
            </div>
            ...
            <p className='pt-8 text-center text-[#dbb434]'>ADVISE</p><p className='pt-2 text-center'>Our responsibility is to provide you with all the necessary information to facilitate informed career choices. We're advisors, not salespeople.</p>
            </div>
            <div>
            <div
