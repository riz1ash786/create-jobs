    ...
    <div  name='privacy' className='w-full h-auto bg-gradient-to-r from-[#050d1c] to-[#0d8bb9] text-gray-300'>
      ...
      <div className='text-center max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              ...
              <p className='font-bold pt-8 text-left'> Data Sharing:</p>
              ...
              <p className=' pt-8 text-left'>If you'd like to view, modify, or delete your personal information, please reach out to us. We're here to assist you with your request.</p>
